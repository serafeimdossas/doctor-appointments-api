...
-- insert doctors
INSERT IGNORE INTO doctor (first_name, last_name, specialty, address, phone, email) VALUES
...
-- insert patients
INSERT IGNORE INTO patient (first_name, last_name, phone, email) VALUES
('Alice', 'Brown', '555-4321', 'alicebrown@email.com'),
('Bob', 'Davis', '555-6789', 'davis.b@email.com'),
('Charlie', 'Wilson', '555-9876', 'charlwil@email.com');

-- insert slots
INSERT IGNORE INTO slot (doctor_id, start_time, end_time, status) VALUES
